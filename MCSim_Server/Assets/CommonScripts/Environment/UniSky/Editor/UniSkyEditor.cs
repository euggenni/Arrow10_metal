...
public class UniSkyEditor : Editor {
	...
	public override void OnInspectorGUI() {
		...
		switch (tabInt) {
			case 0:
				castedTarget.mainCamera = (Camera)EditorGUILayout.ObjectField("Scene Camera", castedTarget.mainCamera, typeof(Camera));
				EditorGUILayout.Separator();
				EditorGUILayout.Separator();
				EditorGUILayout.Separator();
				EditorGUILayout.Separator();
			...
			case 1:
				...
				EditorGUILayout.Separator();
				EditorGUILayout.Separator();
				castedTarget.starTexture = (Texture2D)EditorGUILayout.ObjectField("Star Texture", castedTarget.starTexture, typeof(Texture2D));
				break;
			case 2:
				EditorGUILayout.PrefixLabel("Precipitation Level");
				castedTarget.precipitationLevel = EditorGUILayout.Slider(castedTarget.precipitationLevel, 2f, 0f);
			...
			case 3:
				...
				break;
			case 4:
				castedTarget.moonTexture = (Texture2D)EditorGUILayout.ObjectField("Moon Texture", castedTarget.moonTexture, typeof(Texture2D));
				EditorGUILayout.Separator();
			...
			case 5:
				EditorGUILayout.BeginHorizontal();
				castedTarget.rainAudio = (AudioClip)EditorGUILayout.ObjectField("Rain SFX", castedTarget.rainAudio, typeof(AudioClip));
				EditorGUILayout.EndHorizontal();
				EditorGUILayout.BeginHorizontal();
				castedTarget.stormAudio = (AudioClip)EditorGUILayout.ObjectField("Storm SFX", castedTarget.stormAudio, typeof(AudioClip));
				EditorGUILayout.EndHorizontal();
				EditorGUILayout.BeginHorizontal();
				castedTarget.thunderAudio = (AudioClip)EditorGUILayout.ObjectField("Thunder SFX", castedTarget.thunderAudio, typeof(AudioClip));
				EditorGUILayout.EndHorizontal();
				break;
		}
