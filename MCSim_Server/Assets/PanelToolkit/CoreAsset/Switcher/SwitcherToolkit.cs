...
public class SwitcherToolkit : PanelControl
{
    ...
    public int TumblerStateID
    {
        ...
        set
        {
            ...
            catch { Debug.Log("Having trouble, when trying to switch [" + GetName() + "] state to value " + value); }
        }
    }
    ...
    public override System.Object State
    {
        ...
        set
        {
            ...
            if (value is string)
            {
                ...
                {
                    tumblerStateID = _parentPanelScript.GetTumblers()[TumblerID].GetStatesListAsList().IndexOf((string)value);
    ...
    public Tumbler Tumbler
    {
        get
        {
            if (_parentPanelScript == null) { Debug.Log("Parent is not set for this Tumbler"); return null; }
    ...
    void OnMouseDown()
    {
        ...
        if (showTooltip)
        {
            ...
            for (int i = 0; i < states_name.Length; i++)
            {
                ...
                gt_list[i].guiText.pixelOffset = new Vector2(-states_name[i].Length * gt_list[i].guiText.fontSize * 0.225f, 0);
    ...
    int ClosestTriggerID()
    {
        ...
        for (int i = 0; i < StatesCount; i++)
        {
            ...
            curdistance = (Camera.main.WorldToScreenPoint(States_Transforms[i].position) - Input.mousePosition).sqrMagnitude;
