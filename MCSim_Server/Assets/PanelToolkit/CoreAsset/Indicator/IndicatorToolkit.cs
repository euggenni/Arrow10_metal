...
public class IndicatorToolkit : PanelControl {
    ...
    [SerializeField]
    private ControlPanelToolkit parentPanelScript = null;   // Указатель на скрипт панели, к которой принадлежит этот тумблер
    ...
    public override System.Object State
    {
        ...
        set
        {
            ...
            if (value.GetType().Equals(typeof(System.String)))
            {
                ...
                {
                    IndicatorStateID = parentPanelScript.GetIndicators()[IndicatorID].GetStatesListAsList().IndexOf((string)value);
    ...
    public Tumbler Indicator 
    {
        get
        {
            if (parentPanelScript == null) { Debug.Log("Parent is not set for this Indicator"); return null; }
        ...
        set
        {
            ...
            {
                if (tmblr.GetName().Equals(value.GetName())) { IndicatorID = list.IndexOf(tmblr);    break; }
            }
