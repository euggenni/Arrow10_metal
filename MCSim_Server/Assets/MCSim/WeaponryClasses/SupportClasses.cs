...
namespace MilitaryCombatSimulator
{
    ...
    public interface IWeaponryControl
    {
        ...
        /// <summary>
        /// Инициализировать networkView's на этом Weaponry. Возвращает список ViewID
        /// </summary>
        NetworkViewID[] InitializeNetworkViews();

        /// <summary>
        /// Добавить networkViewID к этому Weaponry, для последующего назначения NetworkView
        /// </summary>
