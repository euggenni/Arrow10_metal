...
public class WeaponryPlane_YF23 : WeaponryPlane, AIControllable {
    #region Ресурсы
    ...
    private void LoadResources()
    {
        ...
        _resources.Add("Icon_WeaponryList", "Icon_WL_YF23"); // Иконка для списка вооружений
    }
    ...
    {
        get { return "WeaponryModel/WeaponryPlane/YF-23/Prefab_YF23"; }
    }
