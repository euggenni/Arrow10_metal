...
public class WeaponryPlane_F111 : WeaponryPlane, AIControllable
{
    #region Ресурсы
    ...
    private void LoadResources()
    {
        ...
        _resources.Add("Icon_WeaponryList", "Icon_WL_F111"); // Иконка для списка вооружений
    }
    ...
    {
        get { return "WeaponryModel/WeaponryPlane/F-111/Prefab_F111"; }
    }
