...
public class WeaponryPlane_F15 : WeaponryPlane, AIControllable 
{
    #region Ресурсы
    ...
    private void LoadResources()
    {
        ...
        _resources.Add("Icon_WeaponryList", "Icon_WL_F15"); // Иконка для списка вооружений
    }
    ...
    {
        get { return "WeaponryModel/WeaponryPlane/F-15/Prefab_F15"; }
    }
