...
public class WeaponryPlane_B2 : WeaponryPlane, AIControllable
{
    #region Ресурсы
    ...
    private void LoadResources()
    {
        ...
        _resources.Add("Icon_WeaponryList", "Icon_WL_B2"); // Иконка для списка вооружений
    }
    ...
    {
        get { return "WeaponryModel/WeaponryPlane/B2/Prefab_B2"; }
    }
