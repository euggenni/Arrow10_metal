...
public class TransformObject
{
    ...
    /// </summary>
    public void SetTransformRotateAround(GameObject goMove)
    {
    
        /*if (goMove != null)
        {
            Debug.LogWarning("get");
            var transformObject = goMove.GetComponent<IsRotate>();
    ...
    public void Update()
    {
        ...
        {
            Debug.LogWarning(mMoveObject.name);
            mMoveObject.RotateAround(Vector3.down, dy * (RotationSpeed/120) * Time.deltaTime);
            //mMoveObject.Rotate(camLeft, dy * RotationSpeed * Time.deltaTime, Space.Self);
