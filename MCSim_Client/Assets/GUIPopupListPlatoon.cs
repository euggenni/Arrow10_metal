...
public class GUIPopupListPlatoon : MonoBehaviour
{
    /// <summary>
    /// Current popup list. Only available during the OnSelectionChange event callback.
    /// </summary>

    static public GUIPopupListPlatoon current;
    ...
    void Start()
    {
        /*switch (this.gameobject.GetComponent<SettingsPopupList>().sourceList)
        {
            case SourceListEnum.PlatoonsList:
                items = GUIMainMenuState.Platoons;
                break;
            case SourceListEnum.StudentList:*/
        items = new List<string>(new string[] { "Уткин", "Прибауткин" });// GUIMainMenuState.Students[GUIMainMenuState.CurrentPlatoon];
                                                                         /*  break;
                                                                       default:
                                                                           break;
                                                                   }*/
