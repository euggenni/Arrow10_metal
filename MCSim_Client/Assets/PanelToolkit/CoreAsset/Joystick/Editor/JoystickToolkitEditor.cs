    ...
    public override void OnInspectorGUI() {
        ...
        if (joystick.X) {
            ...
            if (joystick._state.X.PositionMin != null && joystick._state.X.PositionMax != null)
                joystick._state.X.Value = EditorGUILayout.IntSlider(joystick._state.X.Value, joystick._state.X.Min,
                    joystick._state.X.Max);

            EditorGUILayout.BeginHorizontal();
            joystick._state.X.PositionMin =
                (Transform) EditorGUILayout.ObjectField("", joystick._state.X.PositionMin, typeof(Transform));
            joystick._state.X.PositionMax =
                (Transform) EditorGUILayout.ObjectField("", joystick._state.X.PositionMax, typeof(Transform));
            EditorGUILayout.EndHorizontal();
        ...
        if (joystick.Y) {
            ...
            if (joystick._state.Y.PositionMin != null && joystick._state.Y.PositionMax != null)
                joystick._state.Y.Value = EditorGUILayout.IntSlider(joystick._state.Y.Value, joystick._state.Y.Min,
                    joystick._state.Y.Max);

            EditorGUILayout.BeginHorizontal();
            joystick._state.Y.PositionMin =
                (Transform) EditorGUILayout.ObjectField("", joystick._state.Y.PositionMin, typeof(Transform));
            joystick._state.Y.PositionMax =
                (Transform) EditorGUILayout.ObjectField("", joystick._state.Y.PositionMax, typeof(Transform));
            EditorGUILayout.EndHorizontal();
        ...
        if (joystick.Z) {
            ...
            if (joystick._state.Z.PositionMin != null && joystick._state.Z.PositionMax != null)
                joystick._state.Z.Value = EditorGUILayout.IntSlider(joystick._state.Z.Value, joystick._state.Z.Min,
                    joystick._state.Z.Max);

            EditorGUILayout.BeginHorizontal();
            joystick._state.Z.PositionMin =
                (Transform) EditorGUILayout.ObjectField("", joystick._state.Z.PositionMin, typeof(Transform));
            joystick._state.Z.PositionMax =
                (Transform) EditorGUILayout.ObjectField("", joystick._state.Z.PositionMax, typeof(Transform));
            EditorGUILayout.EndHorizontal();
